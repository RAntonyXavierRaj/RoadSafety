...
# Valuise time as number (from Epoch)
...
X = dataset.drop(['Accident_Severity','Accident_Index','LSOA_of_Accident_Location', 'Local_Authority_(Highway)', '1st_Road_Number', '2nd_Road_Number', 'Local_Authority_(District)'], axis = 1).values
y = dataset.iloc[:, 6].values            # Accident_Severity 
...
categorical = [8,10,11,23,24]   # column number of categorical values 
